...
// Problem 1 // find out all of the shirt sizes
let totalShirtSize = []
runners.forEach(element => {
    totalShirtSize.push(element.shirt_size)
});

let noDuplicates = [...new Set(totalShirtSize)];

console.log(noDuplicates);


// Problem 2 // find out all companies participating in the 5k run

let totalCompanies = []
runners.forEach(element => {
    totalCompanies.push(element.company_name)
    
});

let differentCompanies = [...new Set(totalCompanies)];

console.log(differentCompanies);

// Problem 3 // find the names of all runners in alphabetical order

let nameOrder = []
runners.forEach(element => {
    nameOrder.push(element.first_name)
});
